...
class GEdit:
    def __init__(self):
        self.dataset_name = 'gedit'
        self.dataset_task = 'edit'
        self.ann_path = 'benchmarks/gedit/gedit_edit.json'
        self.num_samples = 604
        self.image_dir = 'benchmarks/gedit/gedit_asset'
    ...
    def __load_data(self):
        ...
        for key, metadata in raw_data:
            processed_data.append({
                ...
                'seed': 0,
                'image_save_path': os.path.join(MODEL_NAME, self.dataset_name, 'images', metadata['id'])
            })
...
class GEditCN:
    def __init__(self):
        self.dataset_name = 'gedit'
        self.dataset_task = 'edit'
        self.ann_path = 'benchmarks/gedit/gedit_edit_cn.json'
        self.num_samples = 604
        self.image_dir = 'benchmarks/gedit/gedit_asset'
        self.data = self.__load_data()
