# --------------------------------------------------------
# InternVL
# Copyright (c) 2024-2026 OpenGVLab
...
class InternRMSNorm(nn.Module):
    """RMS normalization layer used in the InternVLU vision encoder."""
...
class InternVisionEmbeddings(nn.Module):
    """Patch + position embeddings for the InternVLU vision encoder."""
...
class InternMLP(nn.Module):
    """MLP block for the vision transformer encoder."""
...
class InternVisionEncoderLayer(nn.Module):
    """Single transformer encoder block for the InternVLU vision model."""
...
class InternVisionModel(PreTrainedModel):
    """InternVLU vision transformer backbone."""
