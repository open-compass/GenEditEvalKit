...
class InternVLUChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        anyres_image_size=False,
        use_thumbnail=False,
        thumbnail_pos="start",
        enable_multi_scale=False,
        scale_downsample_ratio=0.5,
        ps_version="v1",
        min_dynamic_patch=1,
        max_dynamic_patch=6,
        extra_select_layer=-1,
        **kwargs,
    ):
    ...
    def to_dict(self):
        ...
        output["thumbnail_pos"] = self.thumbnail_pos
        output["enable_multi_scale"] = self.enable_multi_scale
        output["scale_downsample_ratio"] = self.scale_downsample_ratio
        output["ps_version"] = self.ps_version
        output["min_dynamic_patch"] = self.min_dynamic_patch
        output["max_dynamic_patch"] = self.max_dynamic_patch
        output["extra_select_layer"] = self.extra_select_layer
