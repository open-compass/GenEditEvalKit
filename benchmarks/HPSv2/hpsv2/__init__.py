...
def evaluate(imgs_path: str, batch_size: int = 20, checkpoint_path=None, hps_version: str = "v2.1") -> None: # Added parameter checkpoint_path
    ...
    eval.evaluate(mode="benchmark", data_path=data_path, root_dir=imgs_path, checkpoint_path=checkpoint_path, batch_size=batch_size, hps_version=hps_version)
