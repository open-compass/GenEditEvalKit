# Copied from https://github.com/ByteDance-Seed/Bagel/tree/main/eval/gen/kris
...
def main():
    ...
    type_result, subitem_result, meta_result, overall_result = summarize_benchmark_scores_with_normalization(results_dir)
