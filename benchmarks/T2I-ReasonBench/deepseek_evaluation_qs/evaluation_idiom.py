...
if __name__ == "__main__":
    prompt_json = "../prompt/idiom_interpretation.json"
    output_json = "./evaluation_idiom.json"
    ...
    for i in range(start, total):
        ...
        meaning = prompts_json[i]['idiom_meaning'].strip()
        
        instruction = instruction_prepare.format(pid=pid, prompt=prompt, idiom=idiom, idiom_meaning=meaning)
