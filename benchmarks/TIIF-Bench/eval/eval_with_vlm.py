...
def collect_tasks(jsonl_dir, image_dir, eval_model, output_dir, sample_idx_file=None, postfix="_prompts"):
    tasks = []
    ...
    for jsonl_file in jsonl_files:
        ...
        for desc in ['long_description', 'short_description']:
            img_dir = os.path.join(image_dir,attr_type+postfix, desc)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--postfix", type=str, default="_prompts")
